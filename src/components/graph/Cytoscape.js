...
export default class CytoScape extends React.Component
{
  componentDidMount = () => {
   ...
   /* let textColor = '#eeeeee'
    ...
    this.cy.style().selector('node').style({
      ...
      'background-image': node => { return `url(${process.env.PUBLIC_URL + node.data('img')}')`}
    ...
    /*this.cy.style().selector('node:selected').style({
      'border-width': '4',
  ...
  this.cy.style().selector(':parent').style({
  ...
  render(){
    const elements = {
      nodes: [
        ...
        { data: { id: 'A1', parent: 'subnetA',  img: '/assets/img/azure/original/microsoft.network/loadbalancers.svg'}},
        { data: { id: 'A2', parent: 'subnetA', img: '/assets/img/azure/original/microsoft.compute/virtualmachines.svg' }},
        { data: { id: 'A3', parent: 'subnetA',  img: '/assets/img/azure/original/microsoft.compute/virtualmachines.svg' }},

        { data: { id: 'B1', parent: 'subnetB',  img: '/assets/img/azure/original/microsoft.network/loadbalancers.svg'}},
        { data: { id: 'B2', parent: 'subnetB', img: '/assets/img/azure/original/microsoft.compute/virtualmachines.svg' }},
        { data: { id: 'B3', parent: 'subnetB',  img: '/assets/img/azure/original/microsoft.compute/virtualmachines.svg' }},
      ],
    edges: [
